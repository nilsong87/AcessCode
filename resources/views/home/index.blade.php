<x-layout>
    ...
    <main class="main-container"> <!-- Conteúdo principal da página -->
        <img class="main-ft" src="{{ Vite::asset('resources/assets/image/pexels-cottonbro-6321244.jpg') }}"
            alt="Imagem do main"> <!-- Imagem principal -->
        <div class="folder" id="folder"> <!-- Div para o folder -->
            ...
            <button class="login-btn" onclick="window.location.href='app.html';">Teste Agora</button>
            <!-- Botão para testar o aplicativo -->
        </div>
    </main>
    ...
    <section class="sobre-produto" id="sobre-produto"> <!-- Seção sobre o produto -->
        <div class="lado-esquerdo"> <!-- Div do lado esquerdo -->
            ...
            <button class="login-btn" onclick="window.location.href='app.html';">acess code</button>
            <!-- Botão para acessar o aplicativo -->
        </div>

        <div class="lado-direito"> <!-- Div do lado direito -->
            <div class="fundo-verde"> <!-- Div com fundo verde -->
                <img src="{{ Vite::asset('resources/assets/image/pexels-cottonbro-6321925.jpg') }}" alt
                    class="imagem-fundo"> <!-- Imagem de fundo -->
            </div>
            <a href="#home"><img src="{{ Vite::asset('resources/assets/image/99.jpg') }}" alt="Logo"
                    class="logo-negativo"></a> <!-- Logo com link para o topo da página -->
        </div>
    </section>

    <section class="quem-somos" id="quem-somos"> <!-- Seção 'quem somos' -->
        <div class="quem-somos1">
            <img src="{{ Vite::asset('resources/assets/image/icone_libras positivo.jpg') }}" class="imagem-centralizada"
                alt="Imagem Centralizada"> <!-- Imagem centralizada com ícone de Libras -->
            <h1 class="titulo-q">quem somos</h1> <!-- Título principal da seção -->
            <p class="texto-q">
                <!-- Parágrafo descrevendo a missão dos alunos do curso de Programador FullStack do Senac Bahia -->
            ...
            <h2 class="titulo2-q">Time de Desenvolvimento</h2>
            <!-- Título secundário para a seção do time de desenvolvimento -->
            <div class="carousel-container"> <!-- Container do carrossel de imagens -->
                <div class="carousel"> <!-- Carrossel que contém várias caixas com informações dos desenvolvedores -->
                    <div class="carousel-box"> <!-- Caixa do carrossel com imagem e informações do desenvolvedor -->
                        <img src="{{ Vite::asset('resources/assets/image/nilson 01 - sunset.jpg') }}" class="img-c"
                            alt="Funcionário 1">
                    ...
                    <div class="carousel-container">
                        <!-- Carrossel que contém várias caixas com informações dos desenvolvedores -->
                        <div class="carousel">
                            <!-- Caixa do carrossel com imagem e informações do desenvolvedor -->
                            <div class="carousel-box">
                                <img src="img/nilson 01 - sunset.png" class="img-c" alt="Funcionário 1">
                                <p class="nome-func">Nilson Gomes</p>
                                <p class="func-func">Desenvolvedor Líder</p>
                                <a href="https://www.linkedin.com/in/nilson-gomes-dv/" target="_blank"
                                    class="link-azul">
                                    <p class="func-func"><i class="bi bi-linkedin"></i></p>
                                </a>
                                <a href="https://github.com/nilsong87" target="_blank" class="link-roxo">
                            ...
                            <!-- Repetição das caixas do carrossel para outros desenvolvedores -->
                            <div class="carousel-box">
                                <img src="/img/99.jpg" class="img-c" alt="Funcionário 2">
                                <p class="nome-func">Nilson Gomes</p>
                                <p class="func-func">Desenvolvedor Líder</p>
    ...
    <div id="loginModal" class="modal"> <!-- Modal de login -->
        <div class="modal-content"> <!-- Conteúdo do modal -->
            ...
            <div id="register-container" style="display: none;">
                <!-- Container de cadastro, inicialmente escondido -->
